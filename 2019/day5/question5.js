...
const parseInstruction = (instruction) => {
  ...
  paresedInstruction.parm1Mode = remainingInstruction % 10;
  remainingInstruction = Math.floor(remainingInstruction / 10);
  paresedInstruction.parm2Mode = remainingInstruction % 10;
  ...
  while (index < memory.length) {
    ...
    switch (instruction.opCode) {
      case 1:
        ...
        break;
      case 2:
        mul(memory, index, instruction);
        index += 4;
        break;
      case 3:
        ip(memory, index, instruction);
        index += 2;
        break;
      case 4:
